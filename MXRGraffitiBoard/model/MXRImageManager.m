...
{
    return [[NSSearchPathForDirectoriesInDomains(NSCachesDirectory, NSUserDomainMask, YES) firstObject] stringByAppendingPathComponent:@"ImageCaches"];
}
/**
 *  指定缓存文件索引并生成保存路径
 *
...
@implementation MXRImageManager
