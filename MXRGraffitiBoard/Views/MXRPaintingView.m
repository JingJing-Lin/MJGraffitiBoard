...
@interface MXRPaintingView()

/** 照片图层. */
@property (nonatomic, strong) CALayer *imageLayer;

/** 涂鸦图层. */
@property (nonatomic, strong) MXRPaintingLayer *paintingLayer;
...
@implementation MXRPaintingView
...
-(void)setupCommonInit{
    ...
    _paintingLayer            = [MXRPaintingLayer layer];
...
- (void)setPaintBrush:(id<MXRPaintBrush>)paintBrush
{
