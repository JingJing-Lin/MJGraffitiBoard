...
#import "MXRPaintingLayer.h"
#import "MXRPaintBrush.h"
#import "MXRImageManager.h"
...
@implementation MXRPaintingLayer
...
- (void)touchAction:(UITouch *)touch
{
    ...
    switch (touch.phase) {
        ...
        case UITouchPhaseCancelled:
            ...
            [[MXRImageManager sharedImageManger] addImage:self.bitmap];
...
- (void)clear
{
    ...
    [[MXRImageManager sharedImageManger] removeAllImages];
...
- (void)undo
{
    ...
    self.bitmap  = [[MXRImageManager sharedImageManger] imageForUndo];
    self.canUndo = [[MXRImageManager sharedImageManger] canUndo];
    self.canRedo = YES;
...
- (void)redo
{
    ...
    self.bitmap  = [[MXRImageManager sharedImageManger] imageForRedo];
    self.canRedo = [[MXRImageManager sharedImageManger] canRedo];
    self.canUndo = YES;
